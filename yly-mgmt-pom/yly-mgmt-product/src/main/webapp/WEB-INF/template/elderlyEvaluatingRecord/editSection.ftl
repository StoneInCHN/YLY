...
<div style="margin:10px">
	...
	<p style="font-size:130%">模块描述：
		<input type="text" class="easyui-textbox"   validtype="length[0,500]" id="sectionDescription" name="sectionDescription" value="${evaluatingSection.sectionDescription}" data-options="prompt:'请输入模块的描述...',required:true,multiline:true,height:60,width:460" />
	</p>
</div>
</form>