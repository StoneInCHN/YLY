	    ...
	    <table class="table table-striped table-bordered">
	    	<tr>
	    		...
	    		<td>
	    			 ...
	    			 <span title="导入已有的老人信息"><a href="#" id="elderlyInfo_search_btn" class="easyui-linkbutton" onclick="searchAllElderlyInfo()" iconCls="icon-search" plain=true"></a> </span>
	    		</td>
	    	...
	    	<tr>
	    		...
	    		<td>
    			  <select id="gender" class="easyui-combobox" id="gender" name="gender" style="width:50px;">   
