<script src="${base}/resources/modules/bedChargeRecord.js"></script>
...
<div>
	  <fieldset>
		...
		<div class="search-item">
	  	  <button id="bedChargeRecord_search_btn" class="easyui-linkbutton" data-options="iconCls:'icon-search'">${message("yly.search")}</button>
	    </div>
	  </fieldset>
</div>

<table id="bedChargeRecord_table_list"></table>
