<form id="personalizedChargeRecord_form" method="post">   
		  <table class="table table-striped">
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<input class="easyui-textbox" type="text" name="invoiceNo"  readonly=true value="${personalizedCharge.invoiceNo}" style="width:130px;"/> 
	    		</td>
	    		<th>${message("yly.common.charge.billingNo")}:</th>
	    		<td>
	    			<input class="easyui-textbox" type="text" name="billingNo"  readonly=true value="${personalizedCharge.billingNo}" style="width:130px;"/> 
	    		</td>
	    	</tr>
	    	<tr>
	    		<td colspan=4>
