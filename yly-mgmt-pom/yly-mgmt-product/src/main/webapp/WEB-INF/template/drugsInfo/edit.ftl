<form id="editDrugs_form" method="post">   
	   ...
	   <table class="table table-striped">
	    	<tr>
	    		...
	    		<td>
	    			 <input class="easyui-textbox" type="text" value="${drugs.name}" name="name" data-options="required:true" validtype="length[0,60]"/>   
	    		</td>
	    	
	    		<th>${message("yly.drugsInfo.alias")}:</th>
	    		<td>
	    			 <input class="easyui-textbox" type="text" value="${drugs.alias}" name="alias"  validtype="length[0,60]"/>   
	    		</td>
	    	</tr>
	    	<tr>
	    		<th>${message("yly.drugsInfo.phoneticCode")}:</th>
	    		<td>
	    			 <input class="easyui-textbox" type="text" value="${drugs.phoneticCode}" name="phoneticCode"  validtype="length[0,20]"/>   
	    		</td>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			 <input class="easyui-textbox" type="text" value="${drugs.drugSpecifications}" name="drugSpecifications"  validtype="length[0,30]"/>   
	    		</td>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			 <input class="easyui-textbox" type="text" value="${drugs.manufacturer}" name="manufacturer" validtype="length[0,150]" />   
	    		</td>
	    	</tr>
