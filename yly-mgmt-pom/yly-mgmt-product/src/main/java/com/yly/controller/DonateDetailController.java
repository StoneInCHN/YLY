...
public class DonateDetailController extends BaseController
{
  ...
  public @ResponseBody Page<DonateDetail> list (Pageable pageable, ModelMap model)
  {
  ...
  public @ResponseBody Page<DonateDetail> details(Pageable pageable, Long id) {
    Page<DonateDetail> detailPage = donateDetailService.findDonateDetailByRecordId (pageable,id);
    return detailPage;
  }
}
