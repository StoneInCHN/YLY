 ...
 */
@Entity
@Table(name = "yly_meal_charge_config")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "yly_meal_charge_config_sequence")
public class MealChargeConfig extends BaseEntity{
  ...
  @Index(name="meal_charge_config_tenantid")
