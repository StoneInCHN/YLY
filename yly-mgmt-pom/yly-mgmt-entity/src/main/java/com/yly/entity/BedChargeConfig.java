 ...
 */
@Entity
@Table(name = "yly_bed_charge_config")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "yly_bed_charge_config_sequence")
public class BedChargeConfig extends BaseEntity{
  ...
  @Index(name="bed_charge_config_tenantid")
